...
#This is used to run the tests for the MJP Model
...
iters_PPP = 25
iters_ori = 25
resultfilepath = os.path.join(path, "results/MJPruntimeresultsN"+str(nodes)+".txt")
